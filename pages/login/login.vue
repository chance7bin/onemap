<template>
	<view>
		...
		<view class="login-container">
			<view class="app-name">公路移动一张图系统</view>
			<view class="login-form">
				<form @submit="formSubmit">
					...
					<button type="primary" size="mini" style="float: right;" form-type="submit">登录</button>
				</form>
			</view>
		</view>
	</view>
...
<style>
	...
	.login-container{
		background-image: url(../../static/image/loginBackground.jpg);
	...
	.login-form {
		...
		box-shadow: 0 2rpx 10rpx #9B9B9B;
		padding: 20rpx;
	}
